    ...
    return(<>
        <div className="profile-data">
          ...
          <div className="personal">
            ...
            {/* User Email Address */}
            <p className="email-profile">simona@abv.bg</p>
          </div>
        ...
        <div className="dynamic-data-profile">
          {/* Start Uploaded Photos Section */}
          <div className="cocktails-personal">
            {/* Link to Uploaded Cocktail Photo */}
           <Link to="/deteils">
              {/* Cocktail Photo */}
              <img
       ...
       <article className="not-available-photo-profile">
          <h1>You havent uploaded yet…</h1>
